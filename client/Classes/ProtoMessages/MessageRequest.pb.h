...
class MessageRequest : public ::google::protobuf::MessageLite {
 public:
  MessageRequest();
...
inline ::eCommunicationMessageType MessageRequest::messagetype() const {
  // @@protoc_insertion_point(field_get:MessageRequest.messageType)
  return static_cast< ::eCommunicationMessageType >(messagetype_);
}
inline void MessageRequest::set_messagetype(::eCommunicationMessageType value) {
